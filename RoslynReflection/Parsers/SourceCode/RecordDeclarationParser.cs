...
{
    internal class
        RecordDeclarationParser : BaseConcreteTypeDeclarationParser<ScannedSourceRecord, RecordDeclarationSyntax>
    {
        public RecordDeclarationParser(TypeListList typeListList, List<IScannedUsing> scannedUsings,
